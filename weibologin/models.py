...
class Program(models.Model):
    ...
    singer = models.CharField(max_length=45, blank=True, null=True)
    language = models.CharField(max_length=45, blank=True, null=True)
    duration = models.CharField(max_length=45, blank=True, null=True)
    music_genre = models.CharField(max_length=45, blank=True, null=True)
...
class ProgramTopn(models.Model):
    proname = models.CharField(db_column='proName', max_length=500, blank=True, null=True)  # Field name made lowercase.
